namespace Prakticheskai
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                Console.WriteLine("Выберите одну из трех программ: 1 - Угадай число /n, 2-Таблица Умножения, 3-Делители числа, 4-Закончить работу программы ");  
